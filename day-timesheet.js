      ...
      function render(d) {
        ...
        var jobsHtml = rows.length ? rows.map(function (j, i) {
          ...
          return '<div class="mlds-job" data-jid="' + esc(j.jobId) + '">' +
            ...
            '</div>';
        }).join("") : '<div class="mlds-empty">No jobs were recorded for today. Enter your start and finish, then confirm.</div>';
        ...
        sheet.innerHTML =
          ...
          '<div class="mlds-sec"><div class="mlds-lab">Time on each job</div>' + jobsHtml + '</div>' +
